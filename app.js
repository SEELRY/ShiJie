  ...
  onLaunch: function () {
    ...
    onShow: function (options){
      ...
      if (JSON.stringify(options.query) != '{}') {
	    var higher_uid = 0;
	    if (options.query.log_other_uid != undefined && options.query.log_other_uid != '' && options.query.log_other_uid > higher_uid) {
	        higher_uid = options.query.log_other_uid;
	    }
	    requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php/addon/ServiceCard/Api/bindCustomer.html', { higher_uid: higher_uid }, (data) => { console.log(data) }, this, { isShowLoading: false })
	    } else {
	    requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php/addon/ServiceCard/Api/bindCustomer.html', { higher_uid: 0 }, (data) => { console.log(data) }, this, { isShowLoading: false })
	  }
