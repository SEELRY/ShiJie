...
Page({
  data: {
    shop_quan_info: [],
    glo_is_load: true,
    this_quan_d_img: 'http://xrs.duoguan.com/2018-02-05_5a7809c38c0a6.jpg'
  },
  ...
  onShareAppMessage: function () {
    ...
    return {
      ...
      path: '/pages/shop/mallquan/index?qid=' + that.data.shop_quan_info.id + '&log_other_uid=' + log_other_uid
    }
  },
  goHome: function (e) {
