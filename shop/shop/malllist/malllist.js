...
Page({
  ...
  onLoad: function (options) {
    ...
    var this_pinpai_id = options.pid && options.pid != undefined && options.pid != 'undefined' ? options.pid : 0;
    var this_keywords = options.keywords == undefined || options.keywords == 'undefined' ? '' : options.keywords;
  ...
  onShareAppMessage: function () {
    ...
    return {
      title: '发现好货,邀您共享',
      path: '/shop/shop/malllist/malllist?cid=' + that.data.options.cid + '&pid=' + that.data.options.pid + '&keywords=' + that.data.options.keywords + '&log_other_uid' + log_other_uid
    }
  },
})