...
Page({
  ...
  addGoodsLog:function(){
    var that = this;
    requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanShop/DuoguanShopApi/addGoodsLog.html', {
      goods_name: that.data.goods_info.g_name, goods_id:that.data.goods_info.id
    },(data) => {}, this, { isShowLoading: false });
  },
    ...
    requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanShop/DuoguanShopApi/getGoodsInfo.html',
      ...
      (data) => {
        requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanShop/DuoguanShopApi/addGoodsCart.html',
          { goods_id: that.data.this_goods_id, goods_number: that.data.cart_default_number, goods_attr: JSON.stringify(that.data.property_select), goods_price: that.data.goods_show_price, version: 703 },
          (data) => {
            requestUtil.pushFormId(e.detail.formId);
  ...
  initAddCartData: function (data) {
    ...
    requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanShop/DuoguanShopApi/addShoppingList.html',
      { goods_id: data.goods_id, attr_str: data.attr_str, goods_attr: data.goods_attr },
      (data) => { }, this, { isShowLoading: false });
  },
  //联系客服
  ...
  * */
  ...
  onShareAppMessage: function () {
    ...
    requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/ServiceCard/Api/allShareLog', {
      module_name: 'DuoguanShop',
      end_type: 9,
      info: that.data.goods_info.g_name
    }, (data) => { }, this, { isShowLoading: true })
    if (that.data.community_config.is_open == 1) {
      var path = '/pages/shop/malldetail/malldetail?sid=' + that.data.this_goods_id + '&shareuid=' + that.data.uid + '&self_address_id=' + that.data.community_config.self_address_id + '&colonel_uid=' + that.data.community_config.colonel_uid + '&log_other_uid=' + log_other_uid;
      return {
      ...
      var path = '/pages/shop/malldetail/malldetail?sid=' + that.data.this_goods_id + '&shareuid=' + that.data.uid + '&log_other_uid=' + log_other_uid;
